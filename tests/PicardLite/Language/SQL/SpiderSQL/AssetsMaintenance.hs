...
module PicardLite.Language.SQL.SpiderSQL.AssetsMaintenance where
...
assetsMaintenanceSchema =
  let columnNames = HashMap.fromList
        ...
        , ("48", "contact_staff_id")
        , ("61", "part_fault_id")
        , ("7" , "maintenance_contract_company_id")
        , ("25", "supplier_company_id")
        , ("43", "recorded_by_staff_id")
        , ("28", "asset_model")
        , ("57", "fault_short_name")
        , ("13", "chargeable_yn")
        ...
        , ("33", "part_id")
        , ("38", "other_details")
        , ("47", "engineer_visit_id")
        , ("3" , "company_name")
        , ("21", "gender")
        , ("24", "maintenance_contract_id")
        , ("42", "asset_id")
        , ("60", "fault_log_entry_id")
        , ("6" , "maintenance_contract_id")
        , ("9" , "contract_end_date")
      ...
      columnTypes = HashMap.fromList
        ...
        , ("17", ColumnType_TEXT)
        , ("18", ColumnType_TEXT)
        , ("19", ColumnType_NUMBER)
        , ("2" , ColumnType_TEXT)
        , ("20", ColumnType_TEXT)
        , ("21", ColumnType_TEXT)
        , ("22", ColumnType_TEXT)
        , ("23", ColumnType_NUMBER)
        ...
        , ("33", ColumnType_NUMBER)
        , ("34", ColumnType_NUMBER)
        , ("35", ColumnType_NUMBER)
        , ("36", ColumnType_TEXT)
        , ("37", ColumnType_TEXT)
        , ("38", ColumnType_TEXT)
        ...
        , ("43", ColumnType_NUMBER)
        , ("44", ColumnType_TIME)
        , ("45", ColumnType_TEXT)
        , ("46", ColumnType_TEXT)
        , ("47", ColumnType_NUMBER)
        , ("48", ColumnType_NUMBER)
        , ("49", ColumnType_NUMBER)
        , ("5" , ColumnType_TEXT)
        , ("50", ColumnType_NUMBER)
        , ("51", ColumnType_TEXT)
        , ("52", ColumnType_TIME)
        , ("53", ColumnType_TIME)
        , ("54", ColumnType_TEXT)
        , ("55", ColumnType_NUMBER)
        , ("56", ColumnType_NUMBER)
        , ("57", ColumnType_TEXT)
        , ("58", ColumnType_TEXT)
        , ("59", ColumnType_TEXT)
        , ("6" , ColumnType_NUMBER)
        , ("60", ColumnType_NUMBER)
        , ("61", ColumnType_NUMBER)
        , ("62", ColumnType_TEXT)
        , ("63", ColumnType_NUMBER)
        , ("64", ColumnType_NUMBER)
        , ("7" , ColumnType_NUMBER)
        , ("8" , ColumnType_TIME)
        , ("9" , ColumnType_TIME)
        ]
      tableNames = HashMap.fromList
        [ ("7" , "Maintenance_Engineers")
        , ("13", "Skills_Required_To_Fix")
        , ("0" , "Third_Party_Companies")
        , ("12", "Fault_Log_Parts")
...
assetsMaintenanceParserTests =
  Group "assetsMaintenance"
    $  (   ParseQueryExprWithGuardsAndTypeChecking assetsMaintenanceSchema
       <$> assetsMaintenanceQueries
       )
    <> (   ParseQueryExprWithGuards assetsMaintenanceSchema
       <$> assetsMaintenanceQueries
       )
    <> (   ParseQueryExprWithoutGuards assetsMaintenanceSchema
       <$> assetsMaintenanceQueries
       )
    <> (   ParseQueryExprFails assetsMaintenanceSchema
       <$> assetsMaintenanceQueriesFails
       )
...
assetsMaintenanceLexerTests =
  Group "assetsMaintenance"
    $   LexQueryExpr assetsMaintenanceSchema
    <$> assetsMaintenanceQueries
