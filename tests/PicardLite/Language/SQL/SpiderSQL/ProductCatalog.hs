...
module PicardLite.Language.SQL.SpiderSQL.ProductCatalog where
...
productCatalogSchema =
  let columnNames = HashMap.fromList
      ...
      tableNames = HashMap.fromList
        [ ("0", "Attribute_Definitions")
        , ("1", "Catalogs")
        , ("2", "Catalog_Structure")
        , ("3", "Catalog_Contents")
        , ("4", "Catalog_Contents_Additional_Attributes")
        ]
      ...
      foreignKeys =
        HashMap.fromList [("10", "4"), ("13", "9"), ("26", "12"), ("27", "9")]
...
productCatalogParserTests =
  Group "productCatalog"
    $  (   ParseQueryExprWithGuardsAndTypeChecking productCatalogSchema
       <$> productCatalogQueries
       )
    <> (ParseQueryExprWithGuards productCatalogSchema <$> productCatalogQueries)
    <> (   ParseQueryExprWithoutGuards productCatalogSchema
       <$> productCatalogQueries
       )
...
productCatalogLexerTests =
  Group "productCatalog"
    $   LexQueryExpr productCatalogSchema
    <$> productCatalogQueries
