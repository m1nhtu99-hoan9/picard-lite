...
module PicardLite.Language.SQL.SpiderSQL.DepartmentManagement where
...
departmentManagementSchema =
  let
    ...
    tableNames =
      HashMap.fromList [("0", "department"), ("1", "head"), ("2", "management")]
...
departmentManagementParserTests =
  Group "departmentManagement"
    $  (   ParseQueryExprWithGuardsAndTypeChecking departmentManagementSchema
       <$> departmentManagementQueries
       )
    <> (   ParseQueryExprWithGuards departmentManagementSchema
       <$> departmentManagementQueries
       )
    <> (   ParseQueryExprWithoutGuards departmentManagementSchema
       <$> departmentManagementQueries
       )
    <> (   ParseQueryExprFails departmentManagementSchema
       <$> departmentManagementQueriesFails
       )
...
departmentManagementLexerTests =
  Group "departmentManagement"
    $   LexQueryExpr departmentManagementSchema
    <$> departmentManagementQueries
