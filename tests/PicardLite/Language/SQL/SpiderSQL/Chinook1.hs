...
module PicardLite.Language.SQL.SpiderSQL.Chinook1 where
...
chinook1Schema =
  let
    ...
    columnTypes = HashMap.fromList
      ...
      , ("42", ColumnType_TEXT)
      , ("43", ColumnType_TEXT)
      , ("44", ColumnType_NUMBER)
      , ("45", ColumnType_NUMBER)
      , ("46", ColumnType_NUMBER)
      ...
      , ("51", ColumnType_TEXT)
      , ("52", ColumnType_NUMBER)
      , ("53", ColumnType_TEXT)
      , ("54", ColumnType_NUMBER)
      , ("55", ColumnType_NUMBER)
      , ("56", ColumnType_NUMBER)
      , ("57", ColumnType_TEXT)
      , ("58", ColumnType_NUMBER)
      , ("59", ColumnType_NUMBER)
      , ("6" , ColumnType_NUMBER)
      , ("60", ColumnType_NUMBER)
      , ("61", ColumnType_TEXT)
      , ("62", ColumnType_NUMBER)
...
chinook1ParserTests =
  Group "chinook1"
    $  (   ParseQueryExprWithGuardsAndTypeChecking chinook1Schema
       <$> chinook1Queries
       )
...
chinook1LexerTests =
  Group "chinook1" $ LexQueryExpr chinook1Schema <$> chinook1Queries
