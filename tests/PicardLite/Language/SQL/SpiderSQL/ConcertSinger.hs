...
module PicardLite.Language.SQL.SpiderSQL.ConcertSinger where
...
concertSingerParserTests =
  Group "concertSinger"
    $  (   ParseQueryExprWithGuardsAndTypeChecking concertSingerSchema
       <$> concertSingerQueries
       )
...
concertSingerLexerTests =
  Group "concertSinger"
    $   LexQueryExpr concertSingerSchema
    <$> concertSingerQueries
