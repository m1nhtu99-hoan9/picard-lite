...
module PicardLite.Language.SQL.SpiderSQL.Car1 where
...
car1ParserTests =
  Group "car1"
    ...
    <> (   ParseQueryExprFailsTypeChecking car1Schema
       <$> car1QueriesFailsTypeChecking
       )

car1LexerTests :: TestItem
car1LexerTests = Group "car1" $ LexQueryExpr car1Schema <$> car1Queries
