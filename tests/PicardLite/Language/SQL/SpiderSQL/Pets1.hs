...
module PicardLite.Language.SQL.SpiderSQL.Pets1 where
...
pets1Schema =
  let columnNames = HashMap.fromList
      ...
      tableNames =
        HashMap.fromList [("0", "Student"), ("1", "Has_Pet"), ("2", "Pets")]
...
pets1LexerTests = Group "pets_1" $ LexQueryExpr pets1Schema <$> pets1Queries
