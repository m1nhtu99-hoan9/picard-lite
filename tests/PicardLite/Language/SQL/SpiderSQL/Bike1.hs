...
module PicardLite.Language.SQL.SpiderSQL.Bike1 where
...
bike1Schema =
  let
    ...
    tableNames = HashMap.fromList
      [("0", "station"), ("1", "status"), ("2", "trip"), ("3", "weather")]
...
bike1LexerTests = Group "bike1" $ LexQueryExpr bike1Schema <$> bike1Queries
